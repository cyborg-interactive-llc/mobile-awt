...
public class Line2D implements Serializable {
    ...
    /**
     * Constructs and initializes a {@code Line2D} from the specified
     * coordinates.
     *
    ...
    /**
     * Sets the location of the end points of this {@code Line2D} to the
     * specified {@code Point2D} coordinates.
     *
    ...
    /**
     * Sets the location of the end points of this {@code Line2D} to the same as
     * those end points of the specified {@code Line2D}.
     *
     ...
     * {@code (x1,y1)}, in order to point at the specified point
     * {@code (px,py)}.
     * <p>
     ...
     *
     * @param px the X coordinate of the specified point to be compared with
     * this {@code Line2D}
     * @param py the Y coordinate of the specified point to be compared with
     * this {@code Line2D}
    ...
    /**
     * Returns an indicator of where the specified {@code Point2D} lies with
     * respect to this line segment. See the method comments of
     * {@link #relativeCCW(double, double, double, double, double, double)} to
     * interpret the return value.
     *
     * @param p the specified {@code Point2D} to be compared with this
     * {@code Line2D}
     * @return an integer that indicates the position of the specified
     ...
     * segment
     * @return {@code true} if the first specified line segment and the second
     * specified line segment intersect each other; {@code false} otherwise.
     * @since 1.2
     */
    ...
    /**
     * Returns the square of the distance from a {@code Point2D} to this line
     * segment. The distance measured is the distance between the specified
     ...
     *
     * @param pt the specified {@code Point2D} being measured against this line
     * segment.
     * @return a double value that is the square of the distance from the
     * specified {@code Point2D} to the current line segment.
    ...
    /**
     * Returns the distance from a {@code Point2D} to this line segment. The
     * distance measured is the distance between the specified point and the
     * closest point between the current line's end points. If the specified
     * point intersects the line segment in between the end points, this method
     * returns 0.0.
     ...
     * {@code Point2D} to the current line segment.
     ...
     * {@code Line2D}. If the specified point intersects the line, this method
     * returns 0.0.
     *
     * @param px the X coordinate of the specified point being measured against
     * this line
    ...
    /**
     * Returns the square of the distance from a specified {@code Point2D} to
     * this line. The distance measured is the distance between the specified
     * point and the closest point on the infinitely-extended line defined by
     * this {@code Line2D}. If the specified point intersects the line, this
     * method returns 0.0.
     *
     * @param pt the specified {@code Point2D} being measured against this line
     * @return a double value that is the square of the distance from a
     * specified {@code Point2D} to the current line.
     ...
     * infinitely-extended line defined by this {@code Line2D}. If the specified
    ...
    /**
     * Returns the distance from a {@code Point2D} to this line. The distance
     * measured is the distance between the specified point and the closest
     * point on the infinitely-extended line defined by this {@code Line2D}. If
     * the specified point intersects the line, this method returns 0.0.
     *
     ...
     * {@code Line2D}. This method is required to implement the {@link Shape}
     * interface, but in the case of {@code Line2D} objects it always returns
     ...
     * @return {@code false} because a {@code Line2D} contains no area.
     * @since 1.2
     */
    ...
    /**
     * Tests if a given {@code Point2D} is inside the boundary of this
     * {@code Line2D}. This method is required to implement the {@link Shape}
     * interface, but in the case of {@code Line2D} objects it always returns
     * {@code false} since a line contains no area.
     *
    ...
    /**
     * Tests if the interior of this {@code Line2D} entirely contains the
     * specified set of rectangular coordinates. This method is required to
     * implement the {@code Shape} interface, but in the case of {@code Line2D}
    ...
    /**
     * Tests if the interior of this {@code Line2D} entirely contains the
     * specified {@code Rectangle2D}. This method is required to implement the
     * {@code Shape} interface, but in the case of {@code Line2D} objects it
     * always returns {@code false} since a line contains no area.
     *
     ...
     * {@code Line2D}. The iterator for this class is not multi-threaded safe,
     * which means that this {@code Line2D} class does not guarantee that
     * modifications to the geometry of this {@code Line2D} object do not affect
     ...
     * straight line connecting the end points. Since a {@code Line2D} object is
     * always flat, this parameter is ignored.
     * @return a {@code PathIterator} that defines the boundary of the flattened
     * {@code Line2D}
     * @since 1.2
     */
